...
import type { ScheduledEmail } from "@/types/api";

type ScheduledEmailsProps = {
  state: EmailState<ScheduledEmail>;
};

export default function ScheduledEmails({ state }: ScheduledEmailsProps) {
    ...
    return (
      <div className="rounded-xl border border-zinc-200 bg-white">
        <EmptyState
          ...
          description="Click Compose to schedule your first batch."
        />
      </div>
    );
  }
